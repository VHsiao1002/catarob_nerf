...
parser.add_argument("--camera_optimizer", dest="camera_optimizer", type=str, default=default_camera_optimizer, help=f"Camera optimizer mode (off | SO3xR3 | SE3). \nDefault: {default_camera_optimizer}.")
